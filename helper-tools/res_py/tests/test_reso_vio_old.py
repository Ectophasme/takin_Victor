...
IN5 = {
    ...
    "rad_det":[4000.e7, 13e7],                          # [distance, delta]
    "theta_i":[0, 0], # [0., 2.04e-3],                  # [angle, delta]
    "phi_i":[0, 0], # [0., 1.25e-2],                    # [angle, delta]
    "delta_theta_f":3.25e-3,
    "delta_z":10e7,
    "prop_chopP":[np.deg2rad(9.), vc.RPM2rados(7000.), vc.RPM2rados(17000.)],    # [window angle, min rot speed, max rot speed]
    "prop_chopM":[np.deg2rad(3.25), vc.RPM2rados(7000.), vc.RPM2rados(17000.)],    # [window angle, min rot speed, max rot speed]
    "delta_time_det":0
}
...
rot_speedP = vc.RPM2rados(8500)
rot_speedM = vc.RPM2rados(8500)
shape = IN5["det_shape"]
